  ...
  return (
    <div className=" p-8">
      ...
      <div className="flex flex-col gap-2 mt-12 pl-4">
        <For
          each={apps.filter((app) => app.name.toLowerCase().includes(searchTerm?.toLowerCase()))}
        >
          {(app, idx) => {
            return (
              <div
                ...
                className={cn(
                  "Item1 cursor-pointer w-52 h-10 px-2 py-2.5  rounded-lg justify-start items-center gap-2.5 inline-flex",
                  {

  ...
  return (
    <div className='w-full h-full flex flex-col justify-between '>
      ...
      <div className="stat text-xs">
        ...
        <p className=''><span>H:80</span> <span>L:55</span></p>
      </div>
    </div>
  )
}
    ...
    <div className="">
      <div className='w-full h-full flex  justify-between '>
        ...
        <div className="stat text-xs text-right">
          <p className='w-full flex justify-end text-xs'><CloudDrizzle size="20" /></p>
          <p className='mt-1'>Party Cloudy</p>
          <p className=''><span>H:80°</span> <span>L:55°</span></p>
        </div>
      </div>
      <div className="flex justify-between mt-1">
        {[1, 2, 3, 4, 5, 6].map(i => <div key={i} className="flex flex-col gap-1">
          <p className='text-xs text-gray-400 text-center'>2AM</p>
          <p className=''><CloudLightning size="20" /></p>
  ...
  return (
    <div className="">
      ...
      <div className="days flex flex-col gap-1.5 mt-2">
        {[1, 2, 3, 4, 5].map(i => <div key={i} className="day flex w-full justify-between">
          <span className='text-xs'>Wed</span>
          <p className=''><CloudDrizzleIcon size="20" /></p>
...
const WidgetWeather = ({ size = "L", className }: WidgetProps) => {
  ...
  return (
    <div className={cn("relative flex-shrink-0 bg-gradient-to-b to-[#3d3d3d] from-[#0a0b0c] rounded-2xl shadow p-4 ", className, {
